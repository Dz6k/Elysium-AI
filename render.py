...
class Colors: 
    branco = (255, 255, 255, 255)       # Branco puro
    preto = (0, 0, 0, 255)              # Preto puro
    vermelho = (255, 0, 0, 255)         # Vermelho puro
    verde = (0, 255, 0, 255)            # Verde puro
    verde_kelly = (76, 187, 23, 255)    # Verde Kelly
    azul = (0, 0, 255, 255)             # Azul puro
    amarelo = (255, 255, 0, 255)        # Amarelo puro
    ciano = (0, 255, 255, 255)          # Ciano puro
    magenta = (255, 0, 255, 255)        # Magenta puro
    cinza_claro = (211, 211, 211, 255)  # Cinza claro
    cinza_escuro = (169, 169, 169, 255) # Cinza escuro
    laranja = (255, 165, 0, 255)        # Laranja
    roxo = (128, 0, 128, 255)           # Roxo
    rosa = (255, 192, 203, 255)         # Rosa claro
    marrom = (165, 42, 42, 255)         # Marrom
    dourado = (255, 215, 0, 255)        # Dourado
...
class Render:
    ...
    def get_window_dimensions(self, window_name):
        hwnd = FindWindow(None, window_name)
        if hwnd == 0:
            raise Exception(f"Window '{window_name}' don't found")
        ...
        x, y = client_top_left
        width = client_bottom_right[0] - x
        height = client_bottom_right[1] - y
    ...
    def make_window_transparent(self, hwnd):
        # Torna a janela transparente e não interativa
